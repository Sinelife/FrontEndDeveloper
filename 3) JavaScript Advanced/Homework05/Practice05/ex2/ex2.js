...
window.onload = function () {
        ...
        function(e) {
            if (!isValid()) {
                ...
                switch(e.target.value) {
                    case '+':
                        resultField.innerHTML = getResultOfTwoArgs(function(a, b) { return a + b; }); 
                        break;
                    case '-':
                        resultField.innerHTML = getResultOfTwoArgs(function(a, b) { return a - b; }); 
                        break;
                    case '/':
                        resultField.innerHTML = getResultOfTwoArgs(function(a, b) { return b == 0 ? "You can't devide on zero" : a / b; }); 
                        break;
                    case '*':
                        resultField.innerHTML = getResultOfTwoArgs(function(a, b) { return a * b; }); 
                        break;
    ...
    let getResultOfTwoArgs = function(func) {
        return "Result: " + func(parseInt(firstArg.value), parseInt(secondArg.value));
    }
}