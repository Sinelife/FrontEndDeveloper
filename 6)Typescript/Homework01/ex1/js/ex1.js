...
let size = prompt("Input size of ice-cream(big or small)");
// Chosing an ice-cream filling number
let fillingNum = parseInt(prompt("Input num of fillings in ice-cream"));
...
let marshmallows = prompt("Chose if you want to put marshmallows(y - yes)");
